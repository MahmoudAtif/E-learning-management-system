...
urlpatterns = [
    ...
    path('enrolled_free_course/<slug:slug>/' ,views.enrolled_free_course , name='enrolled_free_course'),
    ...
    path('add-to-favourite/<slug:slug>/' ,views.add_to_favourite , name='add_to_favourite'),
    ...
    path('checkout-completed/<int:id>/' , views.CheckoutComplete.as_view() , name='checkout_complete'),
    path('instructor_details/<int:id>/' , views.instructor_details , name='instructor_details'),
...
htmx_urlpattenrs=[
    ...
    path('video-review/<int:id>/<slug:slug>/' ,views.video_review , name='video_review'),
