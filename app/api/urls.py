...
urlpatterns = [
    ...
    path('apicourse/<int:id>/', api_views.CourseViewDetails.as_view() , name='api_course_details'),
    path('apiauthor/', api_views.AuthorView.as_view() , name='api_author'),
    path('apiauthor/<int:id>/', api_views.AuthorDetailView.as_view() , name='api_author_details'),
